...
export function TemplateSettingsSidebar({ template }: TemplateSettingsSidebarProps) {
  const handleOpenPreview = () => {
    const previewWindow = window.open('', '_blank', 'width=1200,height=800');
    if (previewWindow) {
      previewWindow.document.write(template.html_template || '<html><body style="display:flex;align-items:center;justify-content:center;height:100vh;color:#999;font-family:system-ui;">No content yet</body></html>');
