...
export function confirmedPage(businessName?: string, primaryColor?: string): string {
  const color = primaryColor || brandColor;
  const title = businessName ? `${businessName} - Subscription Confirmed` : 'Subscription Confirmed';
...
<div class="site-page-wrapper" style="background-color: #fafafa;">
  <div style="text-align: center; padding: 3rem 2rem; max-width: 500px;">
    ...
    <p style="color: #6b7280; font-size: 1rem; line-height: 1.6; margin-bottom: 2rem;">
      Your email has been confirmed. You&#39;ll now receive updates and newsletters.
    </p>
